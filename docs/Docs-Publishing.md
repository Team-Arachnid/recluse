...
| The stylesheet or script is served as HTML | Assets carry front matter so Jekyll templates them, which also makes the  default apply and wraps them in the site shell. | The  block scopes  to . Keep any new asset under . |
